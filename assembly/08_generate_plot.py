...
# directly copied from https://gitlab.com/ezlab/busco/-/tree/master/scripts

# This is a support script. DO NOT RUN on it's own, script will be called in 08_02_plot_busco_results.sh
